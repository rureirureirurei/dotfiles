...
config.bind('<z><l>', 'spawn --userscript qute-pass -d wmenu')
config.bind('<z><u><l>', 'spawn --userscript qute-pass --username-only -d wmenu')
config.bind('<z><p><l>', 'spawn --userscript qute-pass --password-only -d wmenu')
...
c.editor.command = ['/usr/bin/vi', '{file}']
c.fonts.hints = 'bold 12pt default_family'
c.url.start_pages = ["about:blank"]
c.url.default_page = "about:blank"
c.content.user_stylesheets = "/home/denys/.config/qutebrowser/styles.css"
c.tabs.mousewheel_switching = False
c.content.blocking.enabled = True 


# c.content.blocking.method = 'both'
# c.content.headers.user_agent = 'Mozilla/5.0 ({os_info}; rv:131.0) Gecko/20100101 Firefox/131.0'

#set -u https://accounts.google.com/* content.headers.user_agent "Mozilla/5.0 ({os_info}; rv:131.0) Gecko/20100101 Firefox/131.0"
